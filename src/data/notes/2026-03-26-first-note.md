...
Holy cow. I vibe coded a personality test using open-source science that I vibe-researched. And… it works. Perfectly. And it's genuinely helpful.

I used Perplexity Computer with an insane 35,000 credits in 3 hours (thanks to a promotion from them). For reference, 10,000 credits cost €100 without promotion… But knowing the science deeply, I was able to iterate fast and use all that compute to succeed.
