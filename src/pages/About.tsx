      ...
      <div className="font-body text-base text-foreground leading-[1.85] space-y-5">
        {lang === "fr" ? (
          <>
            ...
            <p>
              J'ai découvert <A href="https://en.wikipedia.org/wiki/The_unexamined_life_is_not_worth_living">la vie examinée</A>. J'ai lu <A href="https://en.wikipedia.org/wiki/Shadow_(psychology)">Jung</A> (surtout à travers <A href="https://en.wikipedia.org/wiki/James_Hollis">James Hollis</A>). J'ai lu <A href="https://en.wikipedia.org/wiki/Baruch_Spinoza">Spinoza</A>, <A href="https://en.wikipedia.org/wiki/René_Descartes">Descartes</A>, <A href="https://en.wikipedia.org/wiki/Michel_Serres">Serres</A>, <A href="https://fr.wikipedia.org/wiki/Alexandre_Jollien">Jollien</A> et <A href="https://en.wikipedia.org/wiki/Matthieu_Ricard">Ricard</A> et bien d'autres. J'ai appris que <A href="https://www.ted.com/talks/brene_brown_the_power_of_vulnerability">la vulnérabilité n'est pas une faiblesse</A>. Que <A href="https://en.wikipedia.org/wiki/Baruch_Spinoza#Ethics">la sagesse ne s'enseigne pas</A> — elle se vit. Que le sens de la vie est peut-être simplement <A href="https://en.wikipedia.org/wiki/The_Boy,_the_Mole,_the_Fox_and_the_Horse">la bonté</A>.
            </p>
